...
const mockNews: NewsItem[] = [
  {
    id: '1',
    title: 'David Alonso dominates opening race of the season',
    excerpt: 'The Colombian rider starts 2025 with a commanding victory.',
  ...
  {
    id: '3',
    title: 'New Honda NSF250R engine upgrade for 2025',
