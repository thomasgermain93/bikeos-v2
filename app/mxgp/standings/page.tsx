...
import { getMXGPStandings, getMXGPRaces } from '@/data/api-mx';
...
function generateFullStandings(baseStandings: Standing[]): Standing[] {
  const additionalRiders = [
    { firstName: 'Glenn', lastName: 'Coldenhoff', number: 259, team: 'F&H Kawasaki Racing Team', nationality: 'NED' },
    { firstName: 'Valentin', lastName: 'Guillod', number: 92, team: 'Team Honda Racing', nationality: 'SUI' },
    { firstName: 'Michele', lastName: 'Cervellin', number: 20, team: 'MRT Racing Team', nationality: 'ITA' },
    { firstName: 'Henry', lastName: 'Jacobi', number: 29, team: 'KMP Honda Racing', nationality: 'GER' },
    { firstName: 'Brent', lastName: 'Van Doninck', number: 32, team: 'F&H Kawasaki Racing Team', nationality: 'BEL' },
    { firstName: 'Kevin', lastName: 'Brumann', number: 36, team: 'Monster Energy Yamaha Factory MXGP Team', nationality: 'SUI' },
    { firstName: 'Mitchell', lastName: 'Evans', number: 43, team: 'KMP Honda Racing', nationality: 'AUS' },
    { firstName: 'Marcel', lastName: 'Conijn', number: 46, team: 'KTM SB Racing', nationality: 'NED' },
    { firstName: 'Lars', lastName: 'van Berkel', number: 707, team: 'HRC Honda', nationality: 'NED' },
    { firstName: 'Noah', lastName: 'Ludwig', number: 300, team: 'KTM Sarholz Racing', nationality: 'GER' },
  ];
...
export default async function MXGPStandingsPage() {
        ...
        <div className="border-b border-zinc-800">
          <div className="max-w-6xl mx-auto px-6 py-8">
            ...
            <nav className="flex items-center gap-2 text-sm mb-6">
              <Link href="/mxgp" className="text-zinc-500 hover:text-zinc-300 transition-colors">
                MXGP
              </Link>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-zinc-500 mt-1">
                  FIM Motocross World Championship — {fullStandings.length} Riders
                </p>
              </div>
